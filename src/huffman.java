...
class Huffman {
	...
	public boolean canEncode(String text){
		if(codes==null ){
			System.out.println("Es gibt noch keine Präfixcodes!");
			return false;
		}else if(text==null){
	...
	public HNode constructPrefixCode(Integer[] frequencies){
		if(frequencies==null){
			System.out.println("Das übergebenen frequencies-Objekt ist null!");
			return null;
		}
	...
	private void makeCodes(HNode n,String code){
		if(n.leftChild!=null){
			makeCodes(n.leftChild,code+"0");
			makeCodes(n.rightChild,code+"1");
		}else{
			//System.out.println(n.chars.charAt(0)+": "+code);
			codes[n.chars.charAt(0)]=code;
		}
	}
	...
	public String decode(String huffmanEncoded, HNode rootNode){
		if(huffmanEncoded==null){
			...
			System.out.println("Es gibt keine root Node!");
			return null;
		}
		String result = "";
